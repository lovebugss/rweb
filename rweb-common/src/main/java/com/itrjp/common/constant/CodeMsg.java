package com.itrjp.common.constant;
...
public class CodeMsg {
    ...
    public static CodeMsg NOT_FOUND = new CodeMsg(400100, "数据不存在");
    ...
    public static CodeMsg NAME_PASSWORD_EMP = new CodeMsg(500217, "用户名或密码未空");
