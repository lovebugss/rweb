...
export const login = createApi(`${path}/login`, option) // 登陆
...
export const staff = createApi(`${path}/user/info`, option) // 用户信息
export const synUser = createApi(`${path}/${prefix}/user/synUser`, option)// 同步用户
export const menu = createApi(`${path}/menu/list`, option) // 获取菜单
